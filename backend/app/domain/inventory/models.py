...
class Zone(Base):
    ...
    sort_order: Mapped[int] = mapped_column(Integer, default=0)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True)
    pos_x: Mapped[int] = mapped_column(Integer, nullable=True)
    pos_y: Mapped[int] = mapped_column(Integer, nullable=True)
    pos_z: Mapped[int] = mapped_column(Integer, nullable=True)
    map_width: Mapped[int] = mapped_column(Integer, nullable=True)
