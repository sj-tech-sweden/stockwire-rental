    ...
    >
      ...
      <template #body-cell-actions="props">
        <q-td :props="props" auto-width>
          <q-btn flat round dense icon="edit" color="primary" class="q-mr-xs" :to="`/jobs/${props.row.id}`" />
        ...
        <div class="q-pa-xs col-12">
          <q-card flat bordered>
            ...
            <q-card-actions align="right">
              <q-btn flat dense icon="edit" color="primary" :to="`/jobs/${props.row.id}`" />
              <template v-if="authStore.canEdit">
...
const showProductionPlannerColumn = computed(() =>
  productionplannerEnabled.value && visibleJobs.value.some(job => job.productionplanner_project_id)
)
...
const columns = computed(() => [
  ...
  ...(showProductionPlannerColumn.value
