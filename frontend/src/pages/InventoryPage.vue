    ...
    <q-tab-panels v-model="tab" animated>
      ...
      <q-tab-panel name="products" class="q-pa-none">
        <div class="row items-center q-mb-sm">
          ...
          <q-btn-dropdown class="q-ml-sm" color="secondary" icon="download" :label="isPhone ? undefined : t('inventory.exportData')" unelevated>
            <q-list dense>
          ...
          <q-btn class="q-ml-sm" color="primary" icon="add" :label="isPhone ? undefined : t('inventory.newProduct')" unelevated @click="openCreateProduct" />
        </div>
