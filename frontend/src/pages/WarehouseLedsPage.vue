<template>
  <q-page class="q-pa-md ec-page">
    <div class="row items-center q-mb-md">
      <div class="text-h5 col">{{ t('warehouseLeds.title') }}</div>
      <div class="row q-gutter-sm">
        <q-btn color="orange" icon="flash_on" :label="t('warehouseLeds.identifyAll')" unelevated @click="onIdentifyAll" />
        <q-btn color="negative" icon="clear_all" :label="t('warehouseLeds.clearAll')" unelevated @click="onClearAll" />
      </div>
    </div>

    <q-tabs v-model="tab" class="text-primary q-mb-md" active-color="primary" indicator-color="primary" narrow-indicator>
      <q-tab name="controllers" :label="t('warehouseLeds.tabs.controllers')" icon="developer_board" />
      <q-tab name="mappings" :label="t('warehouseLeds.tabs.mappings')" icon="linear_scale" />
      <q-tab name="actions" :label="t('warehouseLeds.tabs.actions')" icon="flash_on" />
      <q-tab name="esphome" :label="t('warehouseLeds.tabs.esphome')" icon="code" />
    </q-tabs>
    ...
    <q-tab-panels v-model="tab" animated>
        ...
        <div class="q-gutter-md">
          <q-card flat bordered class="ec-card">
            <q-card-section>
              ...
              <div class="text-caption q-mb-md">{{ t('warehouseLeds.actions.locateDeviceDesc') }}</div>
              <q-input v-model="locateDeviceId" :label="t('warehouseLeds.actions.deviceId')" outlined type="number" class="q-mb-sm" />
          ...
          <q-card flat bordered class="ec-card">
            <q-card-section>
              ...
              <div class="text-caption q-mb-md">{{ t('warehouseLeds.actions.showReturnDesc') }}</div>
              <q-input v-model="returnZoneId" :label="t('warehouseLeds.actions.zoneId')" outlined type="number" class="q-mb-sm" />
          ...
          <q-card flat bordered class="ec-card">
            <q-card-section>
              ...
              <div class="text-caption q-mb-md">{{ t('warehouseLeds.actions.highlightJobDesc') }}</div>
              <q-input v-model="highlightJobId" :label="t('warehouseLeds.actions.jobId')" outlined type="number" class="q-mb-sm" />
      ...
      <!-- ESPHome Tab -->
      <q-tab-panel name="esphome">
        <div class="q-gutter-md">
          <q-card flat bordered class="ec-card">
            <q-card-section>
              <div class="text-subtitle1">{{ t('warehouseLeds.esphome.generateConfig') }}</div>
              <div class="text-caption q-mb-md">{{ t('warehouseLeds.esphome.generateConfigDesc') }}</div>
              <q-select v-model="esphomeController" :options="controllers" option-label="controller_id" option-value="controller_id" :label="t('warehouseLeds.esphome.selectController')" outlined emit-value map-options class="q-mb-sm" />
          ...
          <q-card flat bordered class="ec-card">
            <q-card-section>
              ...
              <div class="text-caption q-mb-md">{{ t('warehouseLeds.esphome.secretsTemplateDesc') }}</div>
          ...
          <q-card v-if="yamlPreview" flat bordered class="ec-card">
            <q-card-section>
